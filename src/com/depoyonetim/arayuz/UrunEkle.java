...
public class UrunEkle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        updateProductBtn.setText("Ürün Ekle");
    ...
    public void cleanText() {
        ...
        codeNumberTxt.setText("");
        salePrice.setText("");
        purchasePrice.setText("");
        shelfNoTxt.setText("");
        bottomShelfNoTxt.setText("");
        stockAmount.setText("");
        categorySelect.setSelectedIndex(-1);
        brandSelected.removeAllItems();
    }
    private void updateProductBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateProductBtnActionPerformed
        ...
        if (productNameTxt.getText().trim().equals("") || codeNumberTxt.getText().trim().equals("") || purchasePrice.getText().trim().equals("") || stockAmount.getText().trim().equals("") || salePrice.getText().trim().equals("") || shelfNoTxt.getText().trim().equals("") || bottomShelfNoTxt.getText().trim().equals("")) {
            ...
            String purchasePrice = veriIslemleri.commaControl(this.purchasePrice.getText());
            String salePrice = veriIslemleri.commaControl(this.salePrice.getText());
            String sorgu = "INSERT INTO `productlist` (`BarcodeNo`, `ProductName`, `StockAmount`, `Category`, `Brand`, `PurchasePrice`, `SalePrice`, `ShelfNo`, `BottomShelfNo`, `Date`, `DateCode`) VALUES ('" + barcodeNo + "', '" + productName + "', '" + stockAmount + "', '" + category + "', '" + brand + "', '" + purchasePrice + "', '" + salePrice + "', '" + shelf + "', '" + bottomShelf + "', '" + dateString + "', '" + dateInteger + "')";
            try {
                veriTabaniBaglantisi.ekle(sorgu);
            } catch (Exception e) {
                System.out.println("Lütfen girdiğiniz fiyatlarda nokta (.) kullanın.");
                e.printStackTrace();
            }

            myErrorMessage.setText("Ürün Başarıyla Eklendi");
